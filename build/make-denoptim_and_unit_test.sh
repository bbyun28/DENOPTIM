...
# To run a specific test
#java -jar ../test/junit/junit-platform-console-standalone-1.5.2.jar -cp lib/DENOPTIM.jar:lib/cdk-1.4.19.jar:lib/gson-2.8.6.jar  -c denoptim.fragspace.FragmentSpaceTest
